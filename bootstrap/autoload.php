...
$composerAutoload = require __DIR__.'/../vendor/autoload.php';


// load main files
$composerAutoload->addPsr4('HS\\Controllers\\', __DIR__ . "/../controllers/", true);
$composerAutoload->addPsr4('HS\\Models\\', __DIR__ . "/../models/", true);
$composerAutoload->addPsr4('HS\\', __DIR__ . "/../providers/", true);
