 ...
 * @package Dusterio\HSPassport\Http\Controllers
 */
class AccessToken extends \Laravel\Passport\Http\Controllers\AccessTokenController
{
    /**
    ...
    public function issueToken(ServerRequestInterface $request)
    {
        $response = $this->withErrorHandling(function () use ($request) {
            ...
            $this->server->enableGrantType(
                $this->makePasswordGrant(), HSPassport::tokensExpireIn(null, $clientId)
            );
        ...
        if (isset($payload['access_token'])) {
            ...
            if ($token->client->firstParty() && HSPassport::$allowMultipleTokens) {
