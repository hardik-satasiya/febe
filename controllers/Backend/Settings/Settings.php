...
class Settings extends Controller
{
    ...
    public function update($author, $plugin, $code = null)
    {
        ...
        $this->vars['parentLink'] = Backend::url('admin/settings/settings');
        ...
        try {
            ...
            if ($item->context == 'mysettings') {
                $this->vars['parentLink'] = Backend::url('admin/settings/settings/mysettings');
    ...
    {
        if (!isset($item->classModel) || !strlen($item->classModel)) {
