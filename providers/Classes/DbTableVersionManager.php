...
class DbTableVersionManager
{
     ...
     */
    public function updateDB($code, $stopOnVersion = null)
    {
     ...
     */
    public function clearDB($code, $stopOnVersion = null)
    {
        if (!$this->hasVersionFile($code)) {
            return false;
        }
    ...
    {
        $versionFile =  base_path() . '/models/'. $code .'/db_updates/version.yaml';
        return $versionFile;
    }
    ...
    protected function applyDatabaseScript($code, $version, $script)
    {
         ...
         */
        $updateFile = base_path() . '/models/'. $code .'/db_updates/' . $script;
