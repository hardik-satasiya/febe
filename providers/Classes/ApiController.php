...
use HS\Classes\FrontendController;
...
class ApiController extends Extendable
{
    ...
    public function __construct()
    {
        ...
        $this->layoutPath = ['~/views/layouts'];
        $layouts = Skin::getActive()->getLayoutPaths();
        if (is_array($layouts)) {
            $this->layoutPath = array_merge($this->layoutPath, $layouts);
        }
