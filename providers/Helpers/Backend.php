...
class Backend
{
    ...
    public function uri()
    {
        // we write our own url to get here
        // return Config::get('hs.backendUri', 'backend');
        return '';
    }
     ...
     */
    public function backendUrl($path = null, $parameters = [], $secure = null)
    {
        $beUri = Config::get('hs.backendUri', 'admin');
        return Url::to($beUri . '/' . $path, $parameters, $secure);
    }
